...
print("Nova frase:", nova)# Strings
# Pode concatenar strings com +, multiplar com *, acessar os elementos com [] e verificar tamanho com len
# Sao imutaveis. para alterara um elemento se faz o seguinte: str1 = str1.replace('M', 'n')
# Para verificar se existem substrings: if 'Ola' in str1
# Para verificar se nao existe uma substring: if 'Ola' not in str1
# Para verificar onde esta a substring: pos1 = str1.find('Mundo')
# Parar separar a string: lista = str1.split(<separador>, <maxsplit>)

# Funcoes para usar com listas: 
# len(<lista>) comprimento 
# min(<lista>) menor item
# max(<lista>) maior item
# sum(<lista>) soma
...
# lista.remove(<item>) remove a primeira ocorrencia do item na lista
# lista.reverse() inverte a ordem
# lista.slice[:inicio :fim :passo]
# lista.sort() ordena em ordem alfabética

# Metodo format: print('Meu {0} disse '"{0}!"'.format('amigo','ola' )). Pode deixar com ou sem numero, o numero da a ordem
# Metodo format: print('Este {objeto} e {adjetivo}.'.format(objeto='oculos', adjetivo='muito feio'). Sao chamados de apelidos
# ano = 2023, disciplina = 'Algoritmos', f'Em {ano} eu aprendi {disciplina}.'
# ano = 2023, chance = 0.4967, 'Ano {:-9} tem {:2.2%} de chance.'.format(ano, chance). Havera 9 casas e serao 2 casas decimais antes e 2 depois, e % e porcentagem
# ano = 2023, disciplina = 'Algoritmos', f'Em {ano:b} eu aprendi {disciplina}.' Ira mudar o formato do ano para binario
