...
# posição (linha e coluna) onde está o maior valor, quantas vezes o maior valor aparece (pode repetir), posição onde está o menor valor, quantas vezes o menor valor aparece
...
for linha in matriz: #itera sobre cada linha na matriz. Para cada linha, a variável linha contém os elementos dessa linha.
    sum(linha)
    for linha in matriz: #para cada linha da matriz, usa-se a função sum para somar todos os elementos da linha.
