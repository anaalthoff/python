...
# Conjuntos são estruturas utilizadas para representar coleções desordenadas de elementos únicos. Não contém elementos repetidos. Não confiar na ordem dos elementos. Pode conter apenas ovjetos imutáveis como inteiros, tuplas, etc, não pode modificar seus elemntos internos, mas pode adicioanr novos.
...
# Adicionando um elemento a todos os elemntos do dicionário
for i in contatos:
