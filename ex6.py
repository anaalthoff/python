...
# deve-se informar o tamanho do array. caso não saiba, pode criar um array vazio a adicioanr os valores posteriormente usado append. Mas se já sabe, melhor especificar para não precisar usar append
...
# Ler um vetor de 8 números inteiros
vetor = []
for i in range(8):
