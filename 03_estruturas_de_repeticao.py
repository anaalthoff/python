...
n = numero
qtd = 1
# Floor division (indicated by // here) truncates the decimal and returns the integer result, while 'normal' division returns the answer you may 'expect' (with decimals)
while n // 10 > 0:
    qtd = qtd + 1
    n = n // 10
...
media = soma / valores
print(f'A média dos {valores} valores é: {media:.2f}')# Repetição
# Conte de 1 a 100
numero = 1
while numero <= 100:
    print(numero)
