...
# Exemplo de soma e multiplicação de Frações
import fractions
...
# é inicializada como 1, pois qualquer número elevado à potência 0 é 1
potencia=1
# é inicializada como 1, para rastrear quantas vezes o loop foi executado
count=1
